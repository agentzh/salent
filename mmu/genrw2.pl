#: genrw2.pl(evolved from genrw.pl)
#: Generate the AST file ,which combined
#: with genrw.tt , to get  rw file randomly.
#: Salent v0.13
...
sub gen_addr {
    return int rand(2 * $capacity * $bytes_perword); #make sure why did I choose 2
}
